...
export default function Home() {
  return (
    <>
      <MaxWithWrapper className="mb-12 mt-16 sm:mt-20 flex flex-col item-center justify-center text-center ">
        ...
        <p className="mt-5 max-w-pose text-zinc-700 sm:text-lg ">
          PrimePdf allows you to have conversation with any pdf documents. simply upload your file and start asking questions right away.
        </p>
        ...
        <button className="flex justify-center items-center">
          <Link className={buttonVariants({
            ...
            target='_blank'>
            Get started{' '}
            <ArrowRight className=" h-9 w-10 text-white text-bold" />
          </Link>
        </button>
        ...
        <div className="relative isolate">
          ...
          <div
            ...
            <div
              ...
              className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]" />
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              chatting to your PDF files has never been easier that PrimePDF.
            </p>
        ...
        <ol className='my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-1-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple. Try PrimePdf today -
